...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "192.168.1.4";
...
//		n.setLatestEventInfo(this, NOTIF_TITLE, text, pi);
	...
	private class MQTTConnection implements MqttCallback {
		...
		public MQTTConnection(String brokerHostName, String initTopic) throws MqttException {
			...
			mqttClient = new MqttClient(mqttConnSpec,MQTT_CLIENT_ID,MQTT_PERSISTENCE);
...
//		}
		...
		public void messageArrived(String topic, MqttMessage message) throws Exception {
			log("topic:"+topic);
			log("Qos:"+message.getQos());
			String s = new String(message.getPayload());
			log("message content:"+s);
			showNotification(s);
		}
